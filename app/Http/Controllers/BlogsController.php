...
class BlogsController extends Controller
{
    public function __construct(){
        $this->middleware(['auth','admin'],['only'=>'trash','restore','permanentDelete']);
        $this->middleware(['auth','author'],['only'=>'create','store','edit','update','delete']);
    }
